...
from pdg_from_veliciny import pdg_from_veliciny, pdg_from_libuska
...
bilancni_skupina = 1
oh_ve_Veliciny = 22 # uved cele cislo napr pro 6.oh odpovida 5:00, proto zadam 5

# FROM'Veliciny.................xlsx'
#veliciny_cplex = pdg_from_libuska('libuska2_report.xlsx', oh_ve_Veliciny)
breakpoint()
veliciny_std = pdg_from_veliciny('6897472_211124_Veliciny PP.xlsx', oh_ve_Veliciny)
breakpoint()
veliciny_cplex = pdg_from_libuska('libuska2_report.xlsx', oh_ve_Veliciny)
# .......................................................................................................................................................................
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
for i in units_cplex:
    ...
    suma_pdg_cplex += i.pdg
    
print(f'suma_nakladu_cplex = {suma_nakladu_cplex}')
print(f'suma_pdg_cplex = {suma_pdg_cplex}')
...
print(f'suma_pdg_std = {suma_pdg_std}')
